  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Log in to PrideHub, the safe and welcoming space for the LGBTQ+ community. Connect with like-minded individuals, share your experiences and perspectives, and be part of a vibrant community that supports and uplifts each other."
        />
