          ...
          >
            <Box display="flex" columnGap={4} alignItems="center" >
              ...
              <Box display="flex" flexDirection="column" columnGap={4} alignItems="center" >
                <IconButton>
                    {cards?.name=="Assistance"?(<AssistantIcon sx={{ fontSize: 35, color: Purples["A100"] }} />):(<></>)}
                    {cards?.name=="User Guide"?(<MenuBookIcon sx={{ fontSize: 35, color: Purples["A100"] }} />):(<></>)}
                    {cards?.name=="Developers"?(<CodeIcon sx={{ fontSize: 35, color: Purples["A100"] }} />):(<></>)}
                </IconButton>
                <Typography
                  variant="h4"
                  sx={{
